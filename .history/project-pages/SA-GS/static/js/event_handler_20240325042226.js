        ...
        function objectSceneEvent(idx) {
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                if(imagesLength == 4 && sections.length == 3){
                    let clone = sections[2].cloneNode(true);
                    dics.appendChild(clone);
                    ...
                    let newSections = dics.getElementsByClassName('b-dics__section');
                    newSections[3].getElementsByClassName('b-dics__image-container')[0].getElementsByClassName('b-dics__text')[0].innerText = 'GT';
                }
                let image = sections[i].getElementsByClassName('b-dics__image-container')[0].getElementsByClassName('b-dics__image')[0]
                switch (idx) {
                    case 0:
