        ...
        function objectSceneEvent(idx) {
            ...
            for (let i = 0; i < imagesLength; i++) {
                ...
                if(imagesLength == 3 && sections.length == 4){
                    tmp = sections[3];
                    tmp_slide = sections[2].getElementsByClassName('b-dics__slider')[0];
                    sections[3].remove();
                    sections[2].getElementsByClassName('b-dics__slider')[0].remove();
                    sections[0].setAttribute('style', 'flex: 0 0 333px;');
                    sections[0].getElementsByClassName('b-dics__slider')[0].setAttribute('style', 'left: 333px;');
                    sections[1].setAttribute('style', 'flex: 0 0 333px;');
                    ...
                    sections[1].getElementsByClassName('b-dics__slider')[0].setAttribute('style', 'left: 666px;');
                    sections[2].setAttribute('style', 'flex: 0 0 333px;');
                ...
                if(imagesLength == 4 && sections.length == 3){
                    ...
                    sections[2].appendChild(tmp_slide);
