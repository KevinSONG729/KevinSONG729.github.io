            ...
            if(flag == true){
                if(Math.abs(tmp - pos_array[0])<= 0.1 && Math.abs(tmp - pos_array[1])<= 0.1){
                    ...
                    if(line_flag[0] == true){
                        ...
                        pos_array[1] = tmp;
                        if(tmp<pos_array[1]) pos_array[0] = tmp;
                    }
                }
                else if(Math.abs(tmp - pos_array[0])<= 0.1) {pos_array[0] = tmp; line_flag[0] = true; line_flag[1] = false;}
                else if(Math.abs(tmp - pos_array[1])<= 0.1) {pos_array[1] = tmp; line_flag[1] = true; line_flag[0] = false;}
            }
        }
        function setflag(e){
            console.log(e);
