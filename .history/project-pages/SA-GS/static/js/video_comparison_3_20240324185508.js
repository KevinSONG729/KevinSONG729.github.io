...
function playVids(videoId) {
    ...
    if (vid.readyState > 3) {
        ...
        function trackLocationTouch(e) {
            ...
            if(flag == true){
                if(Math.abs(tmp - pos_array[0])<= 0.1 && Math.abs(tmp - pos_array[1])<= 0.1) pos_array[0] = tmp;
                else if(Math.abs(tmp - pos_array[0])<= 0.1) pos_array[0] = tmp;
                else if(Math.abs(tmp - pos_array[1])<= 0.1) pos_array[1] = tmp;
            }
        }
        function setflag(e){
            console.log(e);
        ...
        function drawLoop() {
            ...
            var colWidth2 = (vidWidth - (vidWidth * pos_array[1])).clamp(0.0, vidWidth);
            // mergeContext.drawImage(vid, colStart+vidWidth, 0, colStart+vidWidth2, vidHeight, colStart, 0, colStart2, vidHeight);
            // mergeContext.drawImage(vid, colStart+vidWidth2, 0, colWidth, vidHeight, colStart2, 0, colWidth, vidHeight);
